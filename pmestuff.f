...
c     #############################################################
c     ##                                                         ##
c     ##  subroutine grid_mpole_3b  --  put multipoles on PME grid  ##
c     ##                                                         ##
c     #############################################################
c
c
c     "grid_mpole_3b" places the fractional atomic multipoles onto
c     the particle mesh Ewald grid
c
c
      subroutine grid_mpole_3b (fmp)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'chunks.i'
...
c     #################################################################
c     ##                                                             ##
c     ##  subroutine grid_uind_3b  --  put induced dipoles on PME grid  ##
c     ##                                                             ##
c     #################################################################
c
c
c     "grid_uind_3b" places the fractional induced dipoles onto the
c     particle mesh Ewald grid
c
c
      subroutine grid_uind_3b (fuind,fuinp)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'chunks.i'
...
c     ################################################################
c     ##                                                            ##
c     ##  subroutine fphi_mpole_3b  --  multipole potential from grid  ##
c     ##                                                            ##
c     ################################################################
c
c
c     "fphi_mpolei_3b" extracts the permanent multipole potential from
c     the particle mesh Ewald grid
c
c
      subroutine fphi_mpole_3b (fphi)
      implicit none
      include 'sizes.i'
      include 'mpole.i'
      include 'pme.i'
...
c     #############################################################
c     ##                                                         ##
c     ##  subroutine fphi_uind_3b  --  induced potential from grid  ##
c     ##                                                         ##
c     #############################################################
c
c
c     "fphi_uind_3b" extracts the induced dipole potential from
c     the particle mesh Ewald grid
c
c
      subroutine fphi_uind_3b (fdip_phi1,fdip_phi2,fdip_sum_phi)
      implicit none
      include 'sizes.i'
      include 'mpole.i'
      include 'pme.i'
...
c     ###############################################################
c     ##                                                           ##
c     ##  subroutine cmp_to_fmp_3b  --  transformation of multipoles  ##
c     ##                                                           ##
c     ###############################################################
c
c
c     "cmp_to_fmp_3b" transforms the atomic multipoles from Cartesian
c     to fractional coordinates
c
c
      subroutine cmp_to_fmp_3b (cmp,fmp)
      implicit none
      include 'sizes.i'
      include 'mpole.i'
      include 'molcul.i'
...
c     ################################################################
c     ##                                                            ##
c     ##  subroutine fphi_to_cphi_3b  --  transformation of potential  ##
c     ##                                                            ##
c     ################################################################
c
c
c     "fphi_to_cphi_3b" transforms the reciprocal space potential from
c     fractional to Cartesian coordinates
c
c
      subroutine fphi_to_cphi_3b (fphi,cphi)
      implicit none
      include 'sizes.i'
      include 'mpole.i'
      include 'combo.i'
