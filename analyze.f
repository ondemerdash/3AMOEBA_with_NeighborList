...
c
      ...
      epvr1 = 1
      epvr2 = 2
      open(unit=epvr1,file='epvr_2body.txt')
      open(unit=epvr2,file='epvr_3body.txt')
c
c
...
c
      if (use_ewald) then
         value = boundary
         call justify (value)
         write (iout,130)  aewaldPerm,ewaldcut,nfft1,nfft2,nfft3,
     &                    bsorder,value
...
c
c
      subroutine enrgyze (epvr1,epvr2)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'cutoff.i'
