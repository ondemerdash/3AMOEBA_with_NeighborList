...
c
c
      subroutine induce1_3bi_allregewald (fdir,field,fieldp)
      implicit none
      include 'boxes.i'
      include 'sizes.i'
      include 'ewald.i'
...
c
      ...
      call udirect2a_3b2 (field,fieldp)
c
...
c
c
      subroutine induce2_3bi_allregewald (fdir,field,fieldp)
      implicit none
      include 'boxes.i'
      include 'sizes.i'
      include 'ewald.i'
...
c
c
      subroutine induce3_3bi_allregewald (fdir,field,fieldp)
      implicit none
      include 'boxes.i'
      include 'sizes.i'
      include 'ewald.i'
