...
c
      call ewaldcof (aewaldPerm,ewaldcut)
c      call ewaldcof (aewald3b,ewaldcut3b)

      jmaxPerm=int(ewaldcut*aewaldPerm*xbox*aewaldPerm/pi)
      kmaxPerm=int(ewaldcut*aewaldPerm*ybox*aewaldPerm/pi)
      lmaxPerm=int(ewaldcut*aewaldPerm*zbox*aewaldPerm/pi)
      print*,"PermElec vec",jmaxPerm,kmaxPerm,lmaxPerm
      print*,"PermElec aewald",aewaldPerm
c      jmax3b=int(ewaldcut3b*aewald3b*xbox*aewald3b/pi)
c      kmax3b=jmax3b
c      lmax3b=jmax3b
...
c
      if (verbose) then
         write (iout,60)  aewaldPerm,nfft1,nfft2,nfft3,bsorder
