...
c
c
      subroutine torque_3b2 (i,trq1,trq2,frcx,frcy,frcz)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'deriv.i'
...
c     ################################################################
c     ##                                                            ##
c     ##  subroutine torque_reg  --  convert multipole torque to force  ##
c     ##                                                            ##
c     ################################################################
c
c
...
c
c
      subroutine torque_reg (trq,derivs)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'mpole.i'
...
c     ##################################################################
c     ##                                                              ##
c     ##  subroutine torque2_3b  --  convert all site torques to forces  ##        
c     ##                                                              ##
c     ##################################################################
c
c
c     "torque2_3b" takes the torque values on all sites defined by
...
c
c
      subroutine torque2_3b (trq,derivs)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'mpole.i'
