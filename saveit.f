...
c
      ...
      real*8  ep1moli1,ep1moli2,ep2moli12
      real*8  dep1moli1(3,maxatm),dep1moli2(3,maxatm)
      real*8  dep2moli12(3,maxatm)
...
c
        ...
        do moli2 = moli1+1, nmol
          ...
          do l1 = 1, npole3b
            i = pnum(l1)
            do j = 1, 3
              dep3b(j,i) = dep3b(j,i)-dep1moli1(j,i) 
            end do
          end do
          npole3b=6
          pnum(4)=imol(1,moli2)
          ...
          do moli3 = moli2+1, nmol
            ...
            do l1 = 1, npole3b
              i = pnum(l1)
              do j = 1, 3
                dep3b(j,i) = dep3b(j,i)-dep2moli12(j,i)
              end do
            end do
            npole3b=6
            pnum(1)=imol(1,moli1)
            ...
            do l1 = 1, npole3b
              i = pnum(l1)
              do j = 1, 3
                dep3b(j,i) = dep3b(j,i)+dep1moli2(j,i)
              end do
            end do
            npole3b=3
            pnum(1)=imol(1,moli3)
...
c
     ...
     &            pscale(i14(j,ii)) = p4scale * p41scale
         ...
         do l3 = 1, npole3b
            ...
            do l2=1,npole3b
              l=pnum(l2)
              if (i.eq.l.and.l.gt.k) then
                flag=.true.
                go to 100
              else if (i.eq.l.and.l.le.k) then
                flag=.false.
                go to 100
              end if
            end do
...
c
c
      subroutine torque_reg3b (trq,derivs)
      implicit none
      include 'sizes.i'
      include 'atoms.i'
      include 'mpole.i'
